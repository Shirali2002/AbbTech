...
import hw13.model.enums.Status;
import hw13.model.impl.Dog;
...
public class TestFamily {
  ...
  public void testEnv() {
    ...
    Man father2 = new Man("father", "Adigozelov", "01/02/2012", 50,
        Map.of(DayOfWeek.MONDAY, "do homework", DayOfWeek.SATURDAY, "Take the dog for a walk."));
    Woman mother2 = new Woman("mother", "Adigozelova", "01/02/2012", 50,
        Map.of(DayOfWeek.MONDAY, "do homework", DayOfWeek.SATURDAY, "Take the dog for a walk."));
    Woman child2 = new Woman("child1", "Adigozelova", "01/02/2012", 50,
        Map.of(DayOfWeek.MONDAY, "do homework", DayOfWeek.SATURDAY, "Take the dog for a walk."));
    ...
    Man father3 = new Man("father", "Samirov", "01/02/1990", 50,
        Map.of(DayOfWeek.MONDAY, "do homework", DayOfWeek.SATURDAY, "Take the dog for a walk."));
    Woman mother3 = new Woman("mother", "Samirova", "01/02/1990", 52,
        Map.of(DayOfWeek.MONDAY, "do homework", DayOfWeek.SATURDAY, "Take the dog for a walk."));
    Man child3 = new Man("child1", "Samirov", "01/02/2012", 50,
        Map.of(DayOfWeek.MONDAY, "do homework", DayOfWeek.SATURDAY, "Take the dog for a walk."));
  ...
  public void testDeleteChildByWrongObject() {
    ...
    Woman child1 = new Woman("child1Diff", "Adigozelova", "01/02/2012", 50,
        Map.of(DayOfWeek.MONDAY, "do homework", DayOfWeek.SATURDAY, "Take the dog for a walk."));
    Family family1SetChild = new Family(mother1, father1,
        new HashSet<>(List.of(pet1)), new ArrayList<>(List.of(child1))); // for setting status of child1 as CHILD
